		...
		$.ajax({
			...
			success: function(data,status,req){
				...
				if(checkImageType(data)){//이미지 파일
					str="<div><a href='${path}/member/displayFile?fileName="
						+getImageLink(data)+"'>";
				str+="<img src='${path}/member/displayFile?fileName="
						+data+"'></a>"; 
					}else{//이미지가 아닌 경우
						str="<div>";
						str+="<a href='${path}/member/displayFile?fileName="
