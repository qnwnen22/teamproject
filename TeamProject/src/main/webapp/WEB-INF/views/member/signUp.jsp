...
<div class="container-lg joinDiv" style="margin-top: 170px;">
	...
	<div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 offset-xl-2 offset-lg-2 joinForm" style="padding-left: 10px; padding-right: 10px;">
		<form method="post" id="join_form" name="join_form"	action="${path}/member/signUp.do" class="form-horizontal">
			<!-- 이름 -->
			<div>
			...
			<div class="form-group">
				...
				<div class="check_font" id="AAAA"></div>
			</div>
			<!-- 비밀번호 -->
			<div class="form-group">
			...
			<div style="display: flex;">
				...
				<div class="labelname">
					...
					<!-- <input type="hidden" class="form-control" name="postcode"> -->
				</div>
				<div style="display: flex;">
					...
					<div class="form-group d-xl-none d-lg-none col-6 p-0">
						<input type="button" onclick="openDaumZipAddress()"	value="우편번호 찾기" class="btn btn-primary">
					</div>
				</div>
				<!-- ??? -->
				<div id="wrap" class="form-group col-sm-5 col-md-5"	style="display: none; width: 100%;"></div>
				...
				<!-- 이메일 수신 동의 -->
				<div class="form-group">
					<label for="inputEmailReceiveYn" class="col-xl-3 col-lg-3 col-md-4  control-label">이메일 수신여부</label>
					<div class="col-xl-9 col-lg-9 col-md-8 control-radio">
						...
						<label class="radio-inline">
							<input type="radio" id="emailReceiveYn" name="emailReceiveYn" value="N"> 동의하지않습니다.
						</label>
					</div>
				</div>
				<!-- SNS 수신 동의 -->
...
STORE 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
				...
				<div class="form-group text-center">
					<button type="submit" id="join-submit" class="btn btn-primary">회원가입
						<i class="fa fa-check spaceLeft"></i>
					</button>
					<button type="submit" class="btn btn-warning">가입취소
