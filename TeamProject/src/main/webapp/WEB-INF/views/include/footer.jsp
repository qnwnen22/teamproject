  ...
  <div class="container-fluid" id="footer-body">
	...
	<div class="tail_item flex-shrink-2">
	  <div class="title_tail">ACCOUNT INFO</div>
	    <ul class="bank_info">
		  ...
		  <li>예금주: KDEMY</li>
		</ul><a href="https://pgweb.uplus.co.kr/" target="_blank"><img src="include/images/footer/lgup.png" alt=""></a>
	  </div>
	...
	<div class="tail_item flex-shrink-1">
	  <div class="title_tail">WITH US</div>
		...
		<div class="bsns_wrap">
		  <ul class="sns "><li><a href="https://www.youtube.com" target="_blank"><img src="include/images/footer/ico_yt.png" alt="youtube"></a></li>
		    <li><a href="https://www.facebook.com" target="_blank"><img src="include/images/footer/ico_fb.png" alt="facebook"></a></li>
		    <li><a href="https://www.instagram.com" target="_blank"><img src="include/images/footer/ico_ist.png" alt="insta"></a></li>
		    <li><a href="https://twitter.com" target="_blank"><img src="include/images/footer/ico_tw.png" alt="twitter"></a></li>
		  </ul>
		</div>
	  </div>
	  ...
	  <div class="tail_item flex-shrink-0">
	    <div class="title_tail">COMPANY INFO
		  ...
		  <div class="com_info">
		    ...
		    개인정보관리책임자 : 홍길동 | 이메일: hong@naver.com<br>
