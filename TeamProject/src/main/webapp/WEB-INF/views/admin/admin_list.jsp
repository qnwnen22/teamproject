...
<div class="modal-body">
      	<form id="adminupdate" name="adminupdate" action="${path}/admin/insertAdmin.do" method="post">
		<div class="form-group">
		<label for="admin_id">아이디</label>
        <input type="text" class="form-control mb-1" value="${dto.admin_id}"><br>
        <label for="admin_passwd">비밀번호</label>
        <input type="password" class="form-control mb-1" id="admin_passwd" name="admin_passwd" value="${dto.admin_passwd}"><br>
        <label for="admin_name">이름</label>
        <input type="text" class="form-control mb-1" id="admin_name" name="admin_name" value="${dto.admin_name}"><br>
        <label for="admin_hp">연락처</label>
        <input type="text" class="form-control mb-1" id="admin_hp" name="admin_hp" placeholder="ex)01012345678" value="${dto.admin_hp}"><br>
        <label for="admin_email">이메일</label>
        <input type="text" class="form-control mb-1" id="admin_email" name="admin_email" placeholder="ex)abc@naver.com" value="${dto.admin_email}"><br>
		  <label for="admin_level">권한</label>
		  <select class="form-control" id="admin_level" name="admin_level">
		    <option value="3">Master</option>
		    <option value="2">Manager</option>
