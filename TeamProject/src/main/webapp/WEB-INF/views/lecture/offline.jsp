...
<div class="container col-12 col-xl-8 mx-auto">
	<div class="col-12 mx-auto">
		<ul class="upper_shift">
			...
			<li>강사 페이지</li>
			<li><a href="#" style="color:blue;">현장 강의 등록</a></li>
		</ul>
	</div>
	...
	<div class="col-12">
		...
		<div class="form-group">		
			...
			<div class="col-12 form-group mx-0 px-0 ">
				...
				<input type="text" class="form-control" name="lecture_address" id="lecture_address" placeholder="직접 입력하거나 검색 후 지도를 클릭해주세요.">
			</div>
			<!-- 강의장 상세 주소 -->
			<div class="col-12 form-group mx-0 px-0 ">	
