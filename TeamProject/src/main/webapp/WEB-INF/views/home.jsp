						...
						<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" style="height: 300px;">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="${path}/include/images/slide/slide.jpg" class="d-block w-100" style="height: 300px;" alt="...">
								...
								<div class="carousel-item">
									<img src="${path}/include/images/slide/slide2.jpg" class="d-block w-100"  style="height: 300px;"alt="...">
									<div class="carousel-caption d-none d-md-block">
								...
								<div class="carousel-item">
									<img src="${path}/include/images/slide/slide3.jpg" class="d-block w-100" style="height: 300px;" alt="...">
									<div class="carousel-caption d-none d-md-block">
