...
public class LectureDTO {
	...
	public String toString() {
		return "LectureDTO [lecture_idx=" + lecture_idx + ", cell_type=" + cell_type + ", main_category="
				...
				+ lecture_start + ", lecture_time=" + lecture_time + ", lecture_address=" + lecture_address
				+ ", lecture_address2=" + lecture_address2 + ", file1=" + file1 + ", file2=" + file2 + "]";
	}
	public LectureDTO(int lecture_idx, String cell_type, String main_category, String sub_category, String userid,
			String subject, String main_img, String videofile, String content, Date upload_date, int price,
			String lecture_date, String lecture_start, String lecture_time, String lecture_address,
			String lecture_address2, MultipartFile file1, MultipartFile file2) {
		this.lecture_idx = lecture_idx;
		this.cell_type = cell_type;
		this.main_category = main_category;
		this.sub_category = sub_category;
